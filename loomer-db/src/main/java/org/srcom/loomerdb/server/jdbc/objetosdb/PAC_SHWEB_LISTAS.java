...
public class PAC_SHWEB_LISTAS extends AccesoPL {
    ...
    public PAC_SHWEB_LISTAS(Connection con) throws SQLException {
    ...
    private HashMap callPAC_SHWEB_LISTAS__F_GET_LSTPOBLACIONES(String pPROVINCIA) throws Exception {
        ...
        System.out.println("Nos vamos de get_lstpoblaciones");
        cStmt.close(); //AXIS-WLS1SERVER-Ready
        cStmt = null;
        conn.close();
        conn = null;
    ...
    // GARANTIAS 
    public HashMap ejecutaPAC_SHWEB_LISTAS__F_GET_LSTGARANTIAS(String pCONTRA, java.math.BigDecimal pSUPLEM,  java.math.BigDecimal pSUBCAUSA, String pNUMPOL, String pOCU) throws Exception {
        return this.callPAC_SHWEB_LISTAS__F_GET_LSTGARANTIAS( pCONTRA, pSUPLEM, pSUBCAUSA, pNUMPOL, pOCU  );
    }    

    private HashMap callPAC_SHWEB_LISTAS__F_GET_LSTGARANTIAS(String pCONTRA, java.math.BigDecimal pSUPLEM,  java.math.BigDecimal pSUBCAUSA, String pNUMPOL, String pOCU) throws Exception {
    ...
    // F_GET_AVISOS_ALTA
    public HashMap ejecutaPAC_SHWEB_LISTAS__F_GET_AVISOS_ALTA( String pCDCONCLI) throws Exception {
        return this.callPAC_SHWEB_LISTAS__F_GET_AVISOS_ALTA(pCDCONCLI );
    }    

    private HashMap callPAC_SHWEB_LISTAS__F_GET_AVISOS_ALTA( String pCDCONCLI) throws Exception {
        String callQuery="{?=call PAC_SHWEB_LISTAS.F_GET_AVISOS_ALTA(?)}";
        CallableStatement cStmt=conn.prepareCall(callQuery);
        cStmt.setObject (2, pCDCONCLI);
        cStmt.registerOutParameter(1, oracle.jdbc.OracleTypes.CURSOR); // Valor de "RETURN"
        ...
        retVal=new ConversionUtil().convertOracleObjects(retVal); //AXIS-WLS1SERVER-Ready
        //System.out.println("Salida lista GET_AVISOS_ALTA:"+retVal);
        cStmt.close(); //AXIS-WLS1SERVER-Ready
        cStmt = null;
        conn.close();
        conn = null;
    ...
    // F_GET_LISTA_CONSULTAS
    public HashMap  ejecutaPAC_SHWEB_LISTAS__F_GET_LISTA_CONSULTAS( String pORIGEN) throws Exception {
        return this.callPAC_SHWEB_LISTAS__F_GET_LISTA_CONSULTAS(pORIGEN );
    }    

    private HashMap callPAC_SHWEB_LISTAS__F_GET_LISTA_CONSULTAS( String pORIGEN) throws Exception {
    	System.out.println("PAC_SHWEB_LISTAS.F_GET_LISTA_CONSULTAS");
        String callQuery="{?=call PAC_SHWEB_LISTAS.F_GET_LISTA_CONSULTAS(?)}";
        CallableStatement cStmt=conn.prepareCall(callQuery);
