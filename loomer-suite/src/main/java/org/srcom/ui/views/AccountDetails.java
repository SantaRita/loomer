...
import org.srcom.ui.util.css.WhiteSpace;
...
public class AccountDetails extends ViewFrame implements HasUrlParameter<Long> {
	...
	private AppBar initAppBar() {
		...
		appBar.getContextIcon().addClickListener(e -> UI.getCurrent().navigate(Expedientes.class));
